        ...
        <main>
            ...
            {isModalOpen && (
                <div className="fixed top-0 z-[9000] w-full h-full flex items-center justify-center">
                    <div className="w-full h-full fixed top-0 left-0 z-0 bg-black bg-opacity-75 backdrop-blur-sm" onClick={closeModal}></div>
                    <button
                    ...
                    <div className="flex items-center relative top-0 z-[9000] justify-center w-10/12 md:w-6/12">
                        <img
